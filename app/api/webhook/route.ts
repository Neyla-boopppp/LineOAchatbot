...
import { getState, setState, WELCOME_MESSAGE, NON_THAI_DOCS, APPLY_PROMPT, FAQ_INTRO, FAQ_AGE_ANSWER, FAQ_PARTTIME_FALLBACK, BENEFIT_ASK, buildSummaryMessage, buildMissingMessage, type UserState } from '@/lib/session/screening'
