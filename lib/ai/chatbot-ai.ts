...
- นโยบายผู้สมัครต่างชาติ: รับ**เฉพาะแบรนด์ Khao So-i เท่านั้น** แบรนด์อื่น (Potato Corner, Uno Coffee) รับเฉพาะสัญชาติไทย
  ถ้าผู้ใช้ถามว่ารับต่างชาติไหม หรือบอกว่าตัวเองไม่ใช่คนไทย → ต้องแจ้งกฎนี้เสมอ ห้ามตอบว่า "รับทั้งคนไทยและต่างชาติ"
