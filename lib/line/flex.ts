...
export const FAQ_QUICK_ITEMS: { label: string; text: string }[] = [
  ...
  // ⚠️ text ต้องไม่ใช่ 'ตำแหน่งงานที่เปิดรับ' — เป็น action text ของปุ่ม RM1 ที่ตั้งให้บอทเงียบ
  //    ถ้าใช้ซ้ำ ปุ่ม Quick Reply นี้จะกดแล้วเงียบไปด้วย (label โชว์บนปุ่มเฉยๆ ใช้คำเดิมได้)
  { label: 'ตำแหน่งงานที่เปิดรับ', text: 'ตำแหน่งงานว่าง' },
]
